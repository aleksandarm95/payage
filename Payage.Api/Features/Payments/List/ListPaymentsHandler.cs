...
namespace Payage.Api.Features.Payments.List
{
    public class ListPaymentsHandler
    {
        ...
        private readonly ListPaymentsRepository _listPaymentsRepository;

        public ListPaymentsHandler(IDbConnectionFactory dbConnectionFactory, ListPaymentsRepository listPaymentsRepository)
        {
