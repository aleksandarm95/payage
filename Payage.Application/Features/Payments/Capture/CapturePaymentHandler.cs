...
namespace Payage.Application.Features.Payments.Capture
{
    public class CapturePaymentHandler
    {
        ...
        private readonly ICapturePaymentRepository _captureRepository;
        private readonly IPaymentRepository _paymentRepository;
        private IValidator<CapturePaymentRequest> _validator;
        private readonly ILogger<CapturePaymentHandler> _logger;

        public CapturePaymentHandler(IDbConnectionFactory dbConnectionFactory, ICapturePaymentRepository repository, IPaymentRepository paymentRepository, 
        ...
        public async Task<CapturePaymentResponse> HandleAsync(Guid paymentId, CapturePaymentRequest capturePaymentRequest, CancellationToken cancellationToken)
        {
