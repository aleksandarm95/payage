...
namespace Payage.Application.Features.Payments.Authorize
{
    public class AuthorizePaymentHandler
    {
        private readonly IDbConnectionFactory _dbConnectionFactory;
        private readonly IValidator<AuthorizePaymentRequest> _validator;
        private readonly IAuthorizePaymentRepository _repository;
        private readonly ILogger<AuthorizePaymentHandler> _logger;

        public AuthorizePaymentHandler(IDbConnectionFactory dbConnectionFactory, IAuthorizePaymentRepository repository, IValidator<AuthorizePaymentRequest> validator, ILogger<AuthorizePaymentHandler> logger)
        {
